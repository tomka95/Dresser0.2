...
INVARIANT_BLOCK = (
    ...
    "scene, not a textured surface), with soft even lighting and at most a minimal, "
    "soft shadow directly beneath the garment — no long or directional cast shadows. "
